...
- **11 September 2026, kuis.** Pengguna meminta kuis sebagai gerbang sebelum klaim "sudah ingat" dan sebagai tab sendiri. Ini membalik keputusan 9 September yang memilih mode latihan tanpa kuis, dan bertentangan dengan PRD bagian 6 yang mengeluarkan kuis pilihan ganda dari v1. Dikerjakan di cabang `fitur/kuis` dengan titik pulih `v2-sebelum-kuis`, lalu digabung ke produksi pada hari yang sama lewat `944b2fd`.
